...
class CreditsScreen(BaseScreen):
    ...
    def draw(self,surface):
        ...
        draw_background(surface,self.time);lines=(self.context.localization.get("credits.title"),GAME_TITLE,"Python / pygame","Original procedural project","Unverified assets are disabled by default","Version 0.7")
